...
public class ClientContactTest {
  ...
  public void serializeToJSON() throws Exception {
    ...
    ClientContact contact             = new ClientContact(token, "jfdjfkjfkjfkfk", null, false, false);
    ClientContact contactWithRelay    = new ClientContact(token, "jfdjfkjfkjfkfk","whisper", false, false);
    ClientContact contactWithRelayVox = new ClientContact(token, "jfdjfkjfkjfkfk","whisper", true, false);
    ClientContact contactWithRelayVid = new ClientContact(token, "jfdjfkjfkjfkfk","whisper", true, true);
  ...
  public void deserializeFromJSON() throws Exception {
    ClientContact contact = new ClientContact(Util.getContactToken("+14152222222"), "jfdjfkjfkjfkfk",
                                              "whisper", false, false);

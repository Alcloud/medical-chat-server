...
public class DirectoryController {
  ...
  public ClientContacts getContactIntersection(@Auth Account account, @Valid ClientContactTokens contacts)
      throws RateLimitExceededException
  {
    System.out.println("Account.Number by retrieve contacts: " + account.getNumber());
    System.out.println("Request contact list: " + contacts.getContacts().toString());
    ...
    try {
      ...
      System.out.println("decoded tokens list: " + tokens);
      List<ClientContact> intersection = directory.get(tokens);
      System.out.println("Intersection contact list: " + intersection);

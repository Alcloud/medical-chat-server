...
public class AccountController {
    ...
    /*if (!Util.isValidNumber(number)) {
      this.LOG.info("Invalid number: " + number);
      ...
      throw new WebApplicationException(Response.status(400).build());
        ...
        StoredVerificationCode storedVerificationCode = new StoredVerificationCode("", System.currentTimeMillis());
    ...
    public void verifyAccount(@PathParam("verification_code") String verificationCode,
        ...
        try {
            ...
            String authToken = header.getPassword();

            System.out.println("Code verify HEADER: " + number + " " + authToken);

            rateLimiters.getVerifyLimiter().validate(number);

            // register. and validate authToken
            //AuthenticationHelper authenticationHelper = new AuthenticationHelper();

            /*if(authenticationHelper.tokenRegistration(authToken)) {
            ...
            createAccount(number, authToken, userAgent, accountAttributes);
            //} else

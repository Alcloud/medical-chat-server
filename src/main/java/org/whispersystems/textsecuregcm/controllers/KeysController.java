...
public class KeysController {
  ...
  public void setKeys(@Auth Account account, @Valid PreKeyState preKeys)  {
    System.out.println("signed preKeys: " + preKeys.getPreKeys().toString());
    System.out.println("signed preKeys: " + preKeys.getSignedPreKey().toString());
    System.out.println("signed preKeys: " + preKeys.getSignedPreKey().getSignature());
    System.out.println("IdentityKey: " + preKeys.getIdentityKey());

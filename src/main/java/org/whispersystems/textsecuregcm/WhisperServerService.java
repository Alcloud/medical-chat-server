...
public class WhisperServerService extends Application<WhisperServerConfiguration> {
      ...
      throws Exception
  {
    ...
    environment.jersey().register(new AccountController(pendingAccountsManager, accountsManager, rateLimiters, messagesManager, /*turnTokenGenerator,*/ config.getTestDevices()));
